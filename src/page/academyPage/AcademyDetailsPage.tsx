...
const AcademyDetailsPage: React.FC = () => {
  ...
  return (
    <div
      dir="rtl"
      className="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-orange-50 p-4 md:p-8"
    >
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden p-2 md:p-0">
        <div className="grid grid-cols-1 md:grid-cols-3  gap-0">
          <div className="p-6 flex flex-col justify-start order-3 md:order-1">
                ...
                {features.map((feature) => (
                  ...
                  >
                    <FeatureIcon
                      ...
                      className="w-5 h-5 ml-2 text-rose-500"
                    />
            ...
            <button className="mt-auto bg-rose-500 hover:bg-rose-600 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-200">
              مشاهده همه امکانات
            </button>
          </div>
          ...
          <div className="md:col-span-2 order-2">
            ...
            <div className="flex items-center bg-gray-100 p-2 rounded-md mt-2 text-gray-700 text-sm mb-2">
