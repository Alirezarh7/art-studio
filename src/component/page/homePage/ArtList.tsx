  ...
  return (
    <div className="grid grid-cols-2 xl:grid-cols-6 gap-3 md:gap-6 mx-auto my-7">
      {data.map((item, index: number) => (
        <Link key={index} to={item.href} className={`w-[170px] cursor-pointer h-36 md:w-72 md:h-52 rounded-3xl ${item.customClassNameForParentDiv} shadow-lg `}>
          <div className=" relative ">
            <img src={item.imageSRC} alt={item.alt} className="absolute -right-3 h-[100px] w-[100px] md:-right-4 md:h-[170px] md:w-[170px] object-cover" />
            ...
            <div className=" absolute bg-customBlue rounded-2xl text-white p-[2px] px-2  text-[12px] md:text-[18px] font-bold  right-5 top-28 md:top-[165px] md:right-16">
