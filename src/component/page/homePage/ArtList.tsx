...
const data = [
    ...
    },
    {
        ...
        alt: 'راه هنر',
        nameStudy: 'هنر رسانه',
        customClassNameForParentDiv: 'bg-[#e9c257] shadow-[#e9c257]/40 '
    ...
    },
    {
        ...
        alt: 'راه هنر',
        nameStudy: 'هنر سنتی',
        customClassNameForParentDiv: ' bg-[#f07f52]/50 shadow-[#f07f52]/40'
    }
        ...
        <div className="grid grid-cols-2 xl:grid-cols-6 gap-3 md:gap-6 mx-auto my-7">
            {data.map((item, index: number) => (
                <Link key={index} to={item.href}
                      className={`w-[170px] cursor-pointer h-36 md:w-52 md:h-52 rounded-3xl ${item.customClassNameForParentDiv} shadow-lg `}>
                    <div className=" relative ">
                        <img
                            src={item.imageSRC}
                            alt={item.alt}
                            className="absolute -right-3 h-[100px] w-[100px] md:-right-4 md:h-[130px] md:w-[130px] object-cover"
                        />
                        <strong
                        ...
                        <div
                            className=" absolute bg-customBlue rounded-2xl  p-[2px] px-2  text-[12px] md:text-[15px] font-bold  right-5 top-28 md:top-[165px] md:right-16">
                            <p>لیست قسمت ها</p>
                        </div>
                    </div>
                </Link>
