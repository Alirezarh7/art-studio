...
const Honors = () => {
    ...
    const data = [
        ...
        {
            imageSRC: '/image/هنرمندان-هنرستان-پیک آفتاب.PNG',
            imageALT: 'هنرمندان هنرستان-پیک آفتاب',
            text: 'بیش از ۲۰ سال تجربه در تربیت نسل آینده هنرمندان استان'
        },
        {
            imageSRC: '/image/جوایز-هنرستان-پیک آفتاب.PNG',
            imageALT: 'جوایز هنرستان-پیک آفتاب',
            text: 'برگزارکننده موفق ترین نمایشگاه های دانش آموزی'
        },
        {
            imageSRC: '/image/نمایشگاه-هنرستان-پیک آفتاب.PNG',
            imageALT: 'نمایشگاه هنرستان-پیک آفتاب',
