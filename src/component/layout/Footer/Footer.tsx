...
import MdFooter from "./MdFooter.tsx";
...
const Footer = () => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            icon: <CiCreditCard2
                className={selectedTab === "/profile/value" ? "text-primary" : "text-card-foreground"}/>,
            label: "کلاس های من",
        ...
        },
        {
            ...
            icon: profile?.firstName ? (
                <MdOutlineManageAccounts
                    className={selectedTab === "/profile" ? "text-primary" : "text-card-foreground"}/>
            ) : (
                        ...
                        {navItems.map((item) => (
                            ...
                            >
                                {selectedTab === item.id && (
                                    ...
                                    >
                                        <div
                                            className="w-10 h-10 border border-primary rounded-full flex items-center justify-center shadow-2xl ">{item.icon}</div>
                                    </motion.div>
                                )}
                                <span
                                    className={` ${selectedTab === item.id ? "opacity-0" : "opacity-100"}`}>{item.icon}</span>
